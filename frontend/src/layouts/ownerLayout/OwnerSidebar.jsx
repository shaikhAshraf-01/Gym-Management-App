...
import { LayoutDashboard, Dumbbell, Plus, User, LogOut, FileText, CreditCard, X } from "lucide-react";
  ...
  return (
    <>
      ...
      <div className="hidden md:flex w-64 h-screen bg-slate-950 text-white fixed top-0 bottom-0 left-0 z-50 flex-col justify-between p-5 border-r border-slate-900 shadow-2xl">
        ...
        <button onClick={handleLogout} className="flex items-center gap-3 w-full p-2.5 px-4 mt-auto text-sm font-semibold text-red-400 hover:text-red-300 hover:bg-red-950/20 rounded-xl transition-colors cursor-pointer focus:outline-none flex-shrink-0">
