  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 pb-20 text-slate-700 dark:text-slate-100 md:p-8">
      <div className="max-w-xl mx-auto">
        ...
        <button
          onClick={() => navigate("/owner/deleted-members")}
          className="mt-4 flex w-full items-center justify-between gap-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 text-left shadow-xl transition hover:border-rose-400/40"
        >
          <div className="flex items-center gap-3 min-w-0">
            <div className="shrink-0 rounded-xl bg-rose-500/10 p-2.5 text-rose-400">
              <UserX size={20} />
            </div>
            <div className="min-w-0">
              <p className="font-semibold text-slate-700 dark:text-slate-100">Deleted Members</p>
