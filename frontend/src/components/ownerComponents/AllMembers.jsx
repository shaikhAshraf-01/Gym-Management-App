...
export default function AllMembers() {
  ...
  return (
    ...
    <div className="p-2 md:p-6 max-w-7xl mx-auto bg-slate-950 min-h-screen pb-12 md:pb-6">
      {/* Header section */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between border-b border-slate-800 pb-2 mb-4 md:mb-6 gap-4">
      ...
      <div className="bg-slate-900/60 backdrop-blur-sm rounded-xl shadow-sm border border-cyan-500/10 p-2 md:p-6">
