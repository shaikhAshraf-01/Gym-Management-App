...
export default function AddGyms() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Show WhatsApp popup before navigating away.
      ...
      <div className="max-w-2xl mx-auto space-y-6 pb-16">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
            Create the gym and its owner's account. The owner logs in via email
            + OTP — no password to set.
          </p>
        </div>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <p className="text-[11px] text-indigo-600 bg-indigo-50 border border-indigo-100 rounded-lg px-3 py-2">
              The owner will log in using this email — they'll receive a
              one-time code by email each time, no password needed.
            </p>
          </div>
